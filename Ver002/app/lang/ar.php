...
return [
    ...
    'messages' => [
        ...
        'error' => [
            ...
            'insufficient_stock' => 'كمية مخزون غير كافية',
            'invalid_csrf' => 'رمز الأمان غير صالح. يرجى المحاولة مرة أخرى.',
            'invalid_client_data' => 'بيانات العميل غير صالحة'
        ],
        'confirm' => [
            'delete' => 'هل أنت متأكد من أنك تريد حذف هذا العنصر؟',
            'cancel' => 'هل أنت متأكد من أنك تريد الإلغاء؟',
            'logout' => 'هل أنت متأكد من أنك تريد تسجيل الخروج؟'
        ]
    ],
    ...
    'forms' => [
        ...
        'unsaved_changes' => 'لديك تغييرات غير محفوظة. هل أنت متأكد من أنك تريد المغادرة؟'
    ],
    ...
    'validation' => [
        ...
        'min' => 'يجب أن يكون على الأقل :min حرفاً',
        'max' => 'يجب ألا يتجاوز :max حرفاً',
